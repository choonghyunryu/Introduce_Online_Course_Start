...
## 코스 템플리트 설치하기
이네스는 코스 플랫폼을 만들었고, R 강사를 위해서 **"Online course starter: R"**을 배포하고 있습니다. 일종의 코스 템플리트인 셈입니다.
...
이 버튼을 누르면 탬플리트를 가져와서 새로운 리파지토리를 생성하는 Github 사용자 영역의 웹 페이지로 이동합니다.
...
Node.js를 설치하고 설치된 버전을 확인합니다. **npm**도 함께 설치되는데, 이건은 Node.js 패키지를 설치하고 관리하는 유틸리티입니다.
